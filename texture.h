...
// SPATIAL texture, color by spatial coords 
// ignore hit surface


// checker textures can point to some other procedural texture
// in the spirt of shader networks by pat hanrahan
...
class noise_texture : public texture {
  public:
    noise_texture(int scale) : scale(scale) {}
    noise_texture() {}
    color value(double u, double v, const point3& p) const override {
